...
export var JsonFormatter = {
  stringify: function(cipherParams:any) {
    ...
    var jsonObj:any = { ct: cipherParams.ciphertext.toString(crypto.enc.Base64) };
​
...
​
  ...
  parse: function(jsonStr:any) {
    // parse json string
    var jsonObj:any = JSON.parse(jsonStr);
​
    // extract ciphertext from json object, and create cipher params object
    var cipherParams:any = crypto.lib.CipherParams.create({
